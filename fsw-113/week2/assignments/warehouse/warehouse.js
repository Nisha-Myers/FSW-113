...
if (hazardous !== true) {
    ...
    hazardNote.textContent = "Gloves Required";
...
var forklift = document.querySelector("#forkliftNeeded");
var forklift2 = parts.find(function(element, index){
    return parts[index].aisle === "S" || parts[index].aisle === "T" || parts[index].aisle === "U";
})

if (forklift2 == undefined){
    forklift.remove();
} else {
